...
public class studentschedule extends javax.swing.JFrame {
    ...
    public void loadToData() {
        try {
            ...
            String sql = "select l.*,m.TenMH,g.TenGV from LichHoc l inner join MonHoc m on l.MaMH = m.MaMH inner join LopHoc c on c.MaMH = m.MaMH inner join GiangVien g on g.MaGV = l.MaGV";
            ...
            while (rs.next()) {
                ...
                String tenGV = rs.getString(10);
                obj = new Object[] { tenMh, maMH, TenLopString, CaHoc, diemDanh, PhongHoc, tenGV };
                list.add(obj);
            }
            con.close();
        } catch (Exception e) {
    ...
    public void fillToTable() {
        ...
        int i = 1;
        for (Object[] s : list) {
            Object[] rows = new Object[] { i, s[0], s[1], s[2], s[3], s[4], s[5], s[6] };
            model.addRow(rows);
            i++;
        }
    }
    ...
    private void initComponents() {
        ...
        tbl.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Môn học", "Mã môn", "Lớp", "Ca học", "Điểm danh", "Phòng học", "Giảng viên"
            }
        ));
    ...
    private void lblLichthiMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblLichthiMouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_lblLichthiMouseEntered
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(studentschedule.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
